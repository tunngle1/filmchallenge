(function () {
    'use strict';
    Lampa.Noty.show('🚀 V15 (CSS Scroll) Загружен');
    // ========================================
    ...
    function registerHistoryComponent() {
        Lampa.Component.add('challenge365_history', function () {
            ...
            this.create = function () {
                ...
                // V15: Включаем нативный CSS скролл
                var domEl = scroll.render()[0];
                domEl.style.overflowY = 'auto';
                domEl.style.maxHeight = '100%';

                // Чтобы Лампа не перехватывала фокус жестко, даем браузеру работать
                domEl.addEventListener('wheel', function (e) {
                    e.stopPropagation(); // Не даем событию уйти в Lampa Controller
                }, { passive: true });
